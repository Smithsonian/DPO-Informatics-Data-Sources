#!/bin/bash
#
# Load the records with locality and coordinates from a GBIF dump of the NMNH Botany to a PostGIS database.
#
# Data downloaded from the IPT
#  wget "https://collections.nmnh.si.edu/ipt/archive.do?r=nmnh_botany&v=1.4" -O dwca-nmnh_botany-v1.4.zip
#
