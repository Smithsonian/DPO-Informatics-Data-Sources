...
psql -U gisuser -h localhost osm -c "CREATE INDEX osmplanet_p_$1_idx ON planet_osm_polygon USING BTREE(\"$1\") WHERE \"$1\" IS NOT NULL;"
...
#points
#psql -U gisuser -h localhost osm -c "CREATE INDEX osmplanet_po_$1_idx ON planet_osm_polygon USING BTREE(\"$1\") WHERE \"$1\" IS NOT NULL;"
#psql -U gisuser -h localhost osm -c "with data as (
#                                        select
#                                            osm_id as osm_id,
#                                            name,
...
psql -U gisuser -h localhost osm -c "DROP INDEX osmplanet_p_$1_idx;"
#psql -U gisuser -h localhost osm -c "DROP INDEX osmplanet_po_$1_idx;"
